...
public class MyFrame extends JFrame {
	...
	public MyFrame() {
		...
		btn1.addActionListener(new ActionListener() { // add a anonymous ActionListener for Reset
			@Override
			public void actionPerformed(ActionEvent e) {
				mp1.clearAllPoints(); // clean the array(clean the screen)
			}
		});
		btn2.addActionListener(new ActionListener() { // add a anonymous ActionListener for Undo
			@Override
			public void actionPerformed(ActionEvent e) {
				mp1.undoPoint(); // clean the array(clean the screen)
			}
		});
